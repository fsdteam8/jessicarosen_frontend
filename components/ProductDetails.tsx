...
export default function ProductDetails() {
  return (
    <div className="container mx-auto p-6 bg-white space-y-12">
        ...
        <div className="space-y-4">
          <div className="gap-4 flex">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="w-[150px] h-[155px] relative">
                <Image
                  src="/images/aboutUs.jpg"
                  alt="Coffee cup"
                  fill
      ...
      <div>
        ...
        <div className="space-y-4 text-sm text-gray-700 leading-relaxed">
          ...
          <p>
            Let&apos;s start at the beginning. You know I have been teaching business
            law for 15 years at the commercial, corporate, and business law
            level. Our business law is a very important part of business law,
            and it is important to understand the legal framework that governs
            business transactions and relationships and is an integral element
            in business law and the law. Consequently, understanding it, and its
            associated business concepts, is crucial.
          </p>
