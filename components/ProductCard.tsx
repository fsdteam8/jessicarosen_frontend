...
//               className={`absolute top-3 right-3 h-8 w-8 z-10 transition-all duration-200  ${isInWishlist
//                   ? "text-red-500 bg-white/90 hover:bg-white shadow-md"
//                   : "text-gray-400 hover:text-red-500 hover:bg-white/20"
//                 }`}
//             >
//               <Heart
//                 className={`w-6 h-6 transition-all duration-200 text-[#FF0000] ${isInWishlist ? "fill-red-500" : "fill-none"
//                   }`}
//               />
//             </Button>
