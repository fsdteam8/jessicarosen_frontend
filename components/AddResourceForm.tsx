...
//   // Load default thumbnail images as File objects
//   useEffect(() => {
//     const loadThumbnailImages = async () => {
//       const imagePaths = ["/assets/bs1.png", "/assets/bs2.png", "/assets/hh.png"];
//       const files: File[] = [];
...
//           const blob = await response.blob();
//           const fileName = path.split("/").pop() || `thumbnail-${files.length + 1}.png`;
...
//           toast({
//             title: "Error",
//             description: `Failed to load thumbnail image ${path}.`,
//             variant: "destructive",
//           });
//         }
//       }
...
//           variant: "destructive",
//         });
//         setFormData((prev) => ({ ...prev, thumbnail: thumbnailImages[0] || null }));
//         setThumbnailPreview(thumbnailImages[0] ? URL.createObjectURL(thumbnailImages[0]) : "");
//         if (thumbnailInputRef.current) {
//           thumbnailInputRef.current.value = "";
//         }
//         return;
...
//         ? [formData.resourceType]
//         : [],
//       thumbnail: formDataToSubmit.thumbnail
//         ? `https://res.cloudinary.com/dyxwchbmh/image/upload/v_placeholder/resources/thumbnails/thumb_${formDataToSubmit.thumbnail.name}`
//         : null,
//       file: formData.file
//         ? {
//             url: `https://res.cloudinary.com/dyxwchbmh/image/upload/v_placeholder/resources/files/doc_${formData.file.name}`,
...
//                 </CardTitle>
//                 <CardDescription>
//                   Choose a default image or upload a custom one from your device
//                 </CardDescription>
//               </CardHeader>
//               <CardContent className="space-y-4">
//                 <div className="grid grid-cols-3 gap-3">
...
//                     className="text-base font-semibold"
//                   >
//                     Upload Custom Thumbnail from Device
//                   </Label>
//                   <div className="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center bg-gray-50 hover:bg-gray-100 transition-colors">
//                     <input
//                       type="file"
...
//                           src={thumbnailPreview}
//                           alt="Thumbnail preview"
//                           className="max-h-40 w-auto mx-auto rounded-md object-contain cursor-pointer"
//                           onClick={handleThumbnailDelete}
//                         />
//                         <X
//                           className="absolute top-1 right-1 h-5 w-5 text-red-500 bg-white rounded-full p-0.5 cursor-pointer"
//                           onClick={handleThumbnailDelete}
//                         />
//                       </div>
//                     ) : (
...
//               </CardHeader>
//               <CardDescription className="w-full grid grid-cols-3 gap-3 px-3">
