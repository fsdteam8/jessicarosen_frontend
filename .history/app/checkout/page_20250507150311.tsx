...
export default function CheckoutPage() {
  const { items, getSubtotal, getShippingCost, getDiscount, getTotal, clearCart } = useCart()
      ...
      <main className="flex-1">
        ...
        <div className="relative h-[300px] flex items-center">
          ...
          <div className="container mx-auto px-4 z-10 text-white">
            ...
            <h1 className="text-4xl font-bold mb-2">Checkout Page</h1>
          ...
          {items.length === 0 ? (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <div className="lg:col-span-2">
                ...
                <div className="mb-8">
                  <form onSubmit={handleApplyCoupon} className="flex">
                    ...
                    />
                    <Button type="submit" className="rounded-l-none bg-[#2c5d7c] hover:bg-[#1e4258]">
                      Apply
                    </Button>
                  </form>
                </div>
                ...
                <div className="bg-white rounded-lg shadow-sm overflow-hidden p-6">
                  ...
                  <p className="text-gray-500 mb-6">Choose how you would complete your payment</p>
                  ...
                  <div className="space-y-6">
                      ...
                      <div className="pl-6 space-y-4">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div>
                            ...
                            <select id="country" className="w-full h-10 px-3 py-2 border border-gray-300 rounded-md">
                          ...
                          <div>
                            ...
                            <Input id="zip-code" type="text" placeholder="00000" />
                          </div>
                        </div>
                    ...
                    <div className="flex items-center">
                      ...
                      <label htmlFor="paypal" className="ml-2 flex items-center">
                        <span className="mr-4">Pay Pal</span>
                    ...
                    {paymentMethod === "paypal" && (
                      <div className="pl-6">
                        <p className="text-sm text-gray-600">
                          Connect your PayPal account and use it to pay your bills. You will be redirected to PayPal to
                          add your billing informations.
                        </p>
                      </div>
                    )}
                    ...
                    <Button onClick={handlePayment} className="w-full bg-[#2c5d7c] hover:bg-[#1e4258] h-12">
              ...
              <div className="lg:col-span-1">
                <div className="bg-white rounded-lg shadow-sm overflow-hidden p-6 sticky top-24">
